...
// Podemos apelidar os atributos do meu objeto com a palarvra reservada (Exemplo nome as nome1)

console.log(_modulo1__WEBPACK_IMPORTED_MODULE_0__["default"]); //const nome = 'Fernando';
//const obj ={
// nome2, 
//sobrenome,
//idade,
...
//}
//console.log(nome);
//console.log(`Valores nome: ${obj.nome2}`);
//console.log(`sobrenome : ${obj.sobrenome}`);
//console.log(`idade: ${obj.idade}`);
//console.log(`soma ${obj.soma(2,3)}`);
//teste();
//const aluno = new Aluno('Lucas', 'GoStack');
//aluno.infoAluno();
...
/*!************************!*\
  !*** ./src/modulo1.js ***!
  \************************/
/*! exports provided: teste, Aluno, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Aluno = /*#__PURE__*/function () {
  ...
  _createClass(Aluno, [{
    key: "infoAluno",
    value: function infoAluno() {
      console.log('Informações do aluno');
      console.log(" O nome do aluno \xE9 ".concat(this.nome));
      console.log(" O curso do aluno \xE9 ".concat(this.curso));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (empresa);
